<div class="bg-white rounded-lg shadow p-6">
    <h2 class="text-lg font-bold mb-4">Pendaftaran User</h2>
    <form action="{{ route('admin.registerUser') }}" method="POST" class="space-y-4">
        @csrf
        <div>
        ...
        <button type="submit" class="bg-[#f6c90e] text-[#222b45] font-bold px-6 py-2 rounded shadow hover:bg-yellow-400 transition">Daftarkan User</button>
    </form>
</div>
